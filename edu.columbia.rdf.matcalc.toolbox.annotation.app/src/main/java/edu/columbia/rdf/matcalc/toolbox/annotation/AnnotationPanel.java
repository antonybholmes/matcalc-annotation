...
public class AnnotationPanel extends VBox {
	...
	private static final Dimension FIRST_COMBO_SIZE = 
			new Dimension(60, ModernWidget.WIDGET_HEIGHT);
	...
	private static final boolean getIsSelected(String annotationName, String name) {
		Setting setting = SettingsService.getInstance().getSetting(ROOT_SETTING + annotationName + "." + name + ".selected");
